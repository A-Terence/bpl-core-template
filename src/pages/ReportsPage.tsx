...
export default function ReportsPage() {
  ...
  const { events: fleetEvents, vehicles, dataSource } = useFleet();
  ...
  const reportTitle = `${tenant.branding.clientName} Event Report`;
  ...
  }, [dateRange, fromDate, toDate, fleetEvents, vehicles, dataSource]);
    ...
    () =>
      entries.filter(e => {
        ...
        const matchesSearch =
          ...
          (e.driverName && e.driverName !== 'N/A' && e.driverName.toLowerCase().includes(q)) ||
      ...
      <div className="bpl-page-header bpl-page-header-row">
        <div>
          ...
          <p className="bpl-page-subtitle">
            Fleet event log and trend analysis — {dataSource === 'live' ? 'live data' : 'demo data'}
          </p>
        </div>
                ...
                <table className="bpl-reports-table">
                  ...
                  <tbody>
                    {filtered.map((entry, i) => {
                      ...
                      const driverDisplay =
                        entry.driverName && entry.driverName !== 'N/A' ? entry.driverName : null;
                      return (
