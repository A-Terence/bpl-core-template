...
export default function AiInsightsPage() {
  const { notifications, openDetail, dismiss } = useSafeIQ();
    ...
    <FeatureGate featureId="aria">
      ...
      <div className="bpl-aria-page-grid">
        <section className="bpl-aria-page-section">
          ...
          <SafeIQFeed notifications={notifications} onOpen={openDetail} onDismiss={dismiss} />
        </section>
        ...
        <section className="bpl-aria-page-section">
          ...
          <div className="bpl-card bpl-aria-chat-hint">
            <Brain size={18} color="var(--tenant-primary, var(--bpl-blue))" />
            <div>
              <div className="bpl-aria-chat-hint-title">ARIA Assistant</div>
              <p className="bpl-aria-chat-hint-text">Use the chat button bottom-right to ask questions about fleet status, drivers, and safety risks.</p>
            </div>
          </div>
        </section>
      </div>
